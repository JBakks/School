...
class SignUpApp(QMainWindow):
    ...
    def signup_button_clicked(self):
        ...
        if self.password != self.confPassword:
            QMessageBox.information(self, "Alert", "Passwords Do Not Match!", QMessageBox.Ok)
            return
        ...
        try:
            ...
            if self.username in database:
                QMessageBox.information(self, "Alert", "Username already exists. Choose a different username.", QMessageBox.Ok)
                return
            ...
            QMessageBox.information(self, "Alert", "User Made Successfully", QMessageBox.Ok)
            self.close()

...
class Portfolio(QMainWindow):
    ...
    def load_user_stock_data(self):
        ...
        url = "https://portfolio.1aola9rr2nrx.ca-tor.codeengine.appdomain.cloud/user_stocks?user_id=" + username

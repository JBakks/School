...
<?php
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        echo "<tr>";
        // Modify the following line to create a clickable link to the individual TA page
        echo "<td><a href='ta.php?taid={$row['tauserid']}'>{$row['tauserid']}</a></td>";

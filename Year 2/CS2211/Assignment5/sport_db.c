...
int main(void)
{
    ...
    struct athlete *athlete_tbl = NULL;   /* pogints to first athlete */
    struct registration *registration_tb1 = NULL; /* pogints to first registration */
    ...
    for (;;) {
        ...
        if (entity == 'h'){
            ...
            switch (code) {
                case 'i': insert_registration(&registration_tb1);
                            break;
                case 's': search_registration(&registration_tb1);
                            break;
                case 'u': update_registration(&registration_tb1);
                            break;
                case 'p': print_registration(&registration_tb1);
                            break;
                case 'd': dump_registration(&registration_tb1);
                            break;
                case 'r': restore_registration(&registration_tb1);
                            break;
                case 'e': erase_registration(&registration_tb1);
                            break;
                default:  printf("Illegal code\n");
            }
        } 

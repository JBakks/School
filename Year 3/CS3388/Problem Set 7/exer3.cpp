...
int main(int argc, char* argv[])
{
	...
	std::string FragmentShaderCode = "\
		...
		uniform float blend1 = 1.0;\n\
		uniform float blend2 = 0.0;\n\
		out vec4 color;\n\
		void main() {\n\
			//SHADER CODE\n\
				vec4 color1 = texture(tex1, outCoords);\n\
				vec4 color2 = texture(tex2, outCoords);\n\
				vec4 blendedColor = blend1 * color1 + blend2 * color2;\n\
				color = blendedColor;\n\
		}\n";
